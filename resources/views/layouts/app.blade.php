...
<head>
    ...
    <title>@yield('title', 'Gestión de Obras')</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .navbar-logo { width: 32px; height: 32px; background: white; border-radius: 6px; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 12px; color: #1B3F6E; }
